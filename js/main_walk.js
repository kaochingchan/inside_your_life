...
$(document).keydown(function (e) {
    switch (e.which) {
        case 37:    // key left
            ...
            $("#miner").css("width", "calc(57.5vh*0.75)");
            $("#miner").css("height", "calc(77.5vh*0.75)");
            $("#miner").finish().animate({
                left: "-=20"
            });
            console.log("0");
...
$(document).keyup(function (e) {
    switch (e.which) {
        case 37:    // key left
            $("#miner").css("transform", "rotateY(180deg)");
            $("#miner").css("width", "calc(30.3vh * 0.75)");
            $("#miner").css("height", "calc(70.8vh * 0.75)");
